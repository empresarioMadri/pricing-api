...
public class Price {
    ...
    private Price(int brandId, LocalDateTime startDate, LocalDateTime endDate,
                  int priceList, long productId, int priority,
    ...
    public static Price of(int brandId, LocalDateTime startDate, LocalDateTime endDate,
                           int priceList, long productId, int priority,
                           BigDecimal amount, Currency currency) {
